...
const VideoEditingContainer = ({ className = "" }) => {
  ...
  const openConfirmOrderPopup1 = useCallback(() => {
    setConfirmOrderPopup1Open(true);
  }, []);

  const closeConfirmOrderPopup1 = useCallback(() => {
    setConfirmOrderPopup1Open(false);
  }, []);

  const openConfirmOrderPopup = useCallback(() => {
    setConfirmOrderPopupOpen(true);
  }, []);

  const closeConfirmOrderPopup = useCallback(() => {
  ...
  return (
    <>
      <div
        className={`self-stretch flex-1 bg-shades-white flex flex-row items-start justify-center pt-1.5 px-12 pb-[49px] gap-[20px] text-left text-sm text-darkslategray-200 font-roboto md:flex-col ${className}`}
      >
        <div className="self-stretch flex-1 rounded-[10.52px] flex flex-col items-start justify-start py-0 px-[25px] lg:w-full md:flex-[unset] md:self-stretch">
          <img
        ...
        <div className="self-stretch flex-1 flex flex-col items-start justify-start md:flex-[unset] md:self-stretch">
          <div className="self-stretch flex-1 rounded-[10.52px] bg-shades-white flex flex-col items-center justify-center md:flex-col">
            <div className="self-stretch flex-1 flex flex-col items-start justify-between">
              ...
              >
                <div
                  className="rounded-3xs bg-black overflow-hidden flex flex-row items-start justify-start py-1.5 px-[22px] cursor-pointer"
...
VideoEditingContainer.propTypes = {
  className: PropTypes.string,
};

export default VideoEditingContainer;
